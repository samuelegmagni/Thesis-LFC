%% Pressure drops in N2 line with 1/4 inch diameter tubes
clc
clear
...
P_reg = 70;                                     % Pressure downstream the pressure regulator [bar]
...
T = (floor(T10)-45):0.5:(ceil(T10));
P = (floor(P10)-15):0.1:(ceil(P10));
data = nistdata('N2',T,P);
...
title('Pressure evolution: 1/4 inch diameter pipes')
