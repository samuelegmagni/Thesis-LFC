...
P_reg = 78;                                     % Pressure downstream the pressure regulator [bar]
...
T = (floor(T10)-35):0.5:(ceil(T10));
P = (floor(P10)-17):0.1:(ceil(P10));
data = nistdata('N2',T,P);
...
title('Pressure evolution: 6 mm diameter pipes')
