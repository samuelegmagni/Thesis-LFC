...
D_bolt = 6*1e-3;                                      % that accounts for the material of the bolt, lubricants...
K = 0.2;
T_clamping = 11.7;                                    % Grade 8.8: il numero dipende dai trattamenti termici effettuati sulla vite 
F_bolt = T_clamping/(D_bolt*K);

n_bolt = 4;
F_tot_bolt = F_bolt*n_bolt

d_circ = 66;                                        % O-Ring diameter [mm]
l_circ = pi*d_circ;
