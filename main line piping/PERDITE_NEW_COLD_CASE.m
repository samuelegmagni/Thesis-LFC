...
clear k; clear mu; clear Mw; clear omega; clear P; clear pc; clear rho;
clear Rho; clear s; clear S; clear species; clear T; clear Tc; clear u;
clear U; clear V
...
P_tot29 = P29*(1 + 0.5*(gamma29 - 1)*M29^2);
P30 = 1;
