...
mdotvect = [21 27 61 78]*1e-3;
P_in_MFMvect = [7.136 9.443 22.5 29.04];
...
if (m_dot_N2 == 21*1e-3 )
    ...
    x_21 = [50 45 40 30 25 20 15 10 8 7.136];
    y_21 = [0.645 0.7161 0.8051 1.073 1.289 1.618 2.192 3.536 5.032 7.136];

    poly_21 = polyfit(x_21,y_21,2);
    deltaP_MFM = polyval(poly_21,P18);

   
    clear poly_21; clear x_21; clear y_21;

elseif (m_dot_N2 == 27*1e-3 )
    
    x_27 = [50 45 40 30 25 20 15 10 9.433];
    y_27 = [1.071 1.190 1.340 1.795 2.168 2.752 3.834 7.380 9.433];

    poly_27 = polyfit(x_27,y_27,1);
    deltaP_MFM = polyval(poly_27,P18);

    clear poly_27;
    clear x_27; clear y_27

 elseif (m_dot_N2 == 61*1e-3 )
    
    x_61 = [80 70 60 50 40 30 25 22.50];
    y_61 = [3.48 3.997 4.703 5.729 7.393 10.76 14.83 22.5];

    poly_61 = polyfit(x_61,y_61,1);
    deltaP_MFM = polyval(poly_61,P18);

    clear poly_61;
    clear x_61; clear y_61

else
    
    x_78 = [90 80 70 60 50 40 35 30 29.04];
    y_78 = [5.099 5.773 6.664 7.905 9.779 13.09 16.14 23.29 29.04];

    poly_78 = polyfit(x_78,y_78,2);
    
    deltaP_MFM = polyval(poly_78,P18);
    
    clear poly_78; clear x_78; clear y_78
